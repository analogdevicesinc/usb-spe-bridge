...
typedef struct __attribute__((packed)) {
    ...
    bool vlanEnabled;
    bool vlanBlock;
    uint16_t vlanEntry1 __attribute__((aligned(2)));
    uint16_t vlanEntry2 __attribute__((aligned(2)));

    bool etypeEnabled;
    bool etypeBlock;
    uint16_t etypeEntry1 __attribute__((aligned(2)));
    uint16_t etypeEntry2 __attribute__((aligned(2)));
